    ...
    def validate(self, epoch, save=False, visualize=False):
        ...
        with torch.no_grad():
            for i, (sample, target, road_image, extra) in enumerate(self.valloader):
                ...
                final_coor, batched_threat_sum = batched_coor_threat_updated(i, out_bbox, self.anchor_boxes, target, self.batch_sz, nms_threshold=0.1, plot=False)
